...
- 本项目为自动化论文评审状态监控脚本，支持多账号监控、定时检测、邮件提醒。
- 适用于中国石油大学（北京）人工智能学院所采用的 [凡科评审系统](https://11414.lwglxt.com/) 自动追踪专家评审进度。
- 凡科平台本身虽本身具备"短信+邮件+微信公众号"的一系列通知方式，但由于学校并未开放相应权限，故此开发本脚本。
## 🧩 功能特点
...
- 关于docid的获取参考如下图片，访问进入凡科平台后，进入论文的盲审页面，上方连接中的数字部分即为docid
<p align="center">
